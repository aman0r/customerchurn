...
logo = Image.open("/Users/gadangbeking/PycharmProjects/ICCPWA_G6/FOXTECH LOGO.jpeg") ### Loading of Company Logo
st.image(logo,caption="",width=300)

#Looading data at the Global level
try:
    dataset = pd.read_csv("/Users/gadangbeking/PycharmProjects/ICCPWA_G6/WA_Fn-UseC_-Telco-Customer-Churn.csv")
...
def page4():
    ...
    if submit:
        ...
        class PDF(FPDF):
            def header(self):
                # Add FOXTECH logo
                self.image("/Users/gadangbeking/PycharmProjects/ICCPWA_G6/FOXTECH LOGO.jpeg", x=10, y=8, w=30)
